...
<main class="bg-light">
  ...
  <div class="container py-5">
    ...
    echo '<a href="pages_create.php" class="btn btn-primary float-end mb-2">Create New Page</a>';
    ...
    if ($num > 0) {
      ...
      while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<td>';
        // read one record 
        echo '<a href="pages_read_one.php?id=' . $row['id'] . '" class="btn btn-info btn-sm me-2 mb-1">Read</a>';

        // update one record
        echo '<a href="pages_update.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm me-2 mb-1">Edit</a>';

        // delete one record but with confirmation warning
        echo '<a href="#" data-href="pages_read.php?delete=' . $row['id'] . '" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="btn btn-danger btn-sm mb-1">Delete</a>';
        echo '</td>';
        echo '</tr>';
      }
